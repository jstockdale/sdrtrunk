...
public enum P25P1DataUnitID
{
    ...
    private final boolean mTrailingStatusDibit;
    private final String mLabel;

    P25P1DataUnitID(int value, int length, int elapsedDibitLength, boolean trailingStatusDibit, String label)
    {
        mValue = value;
        mMessageLength = length;
        mElapsedDibitLength = elapsedDibitLength;
    ...
    public static final EnumSet<P25P1DataUnitID> DEBUG_VALIDATED_ELAPSED_DIBIT_COUNTS = EnumSet.of(HEADER_DATA_UNIT,
            TERMINATOR_DATA_UNIT, LOGICAL_LINK_DATA_UNIT_1, LOGICAL_LINK_DATA_UNIT_2, TRUNKING_SIGNALING_BLOCK_1,
            TERMINATOR_DATA_UNIT_LINK_CONTROL, PACKET_DATA_UNIT);

    /**
     * Temporary use to identify the elapsed dibit lengths for all of the primary DUIDs for the soft symbol processor
     */
    public boolean isValidatedElapsedDibitLengthDUID()
    {
        return DEBUG_VALIDATED_ELAPSED_DIBIT_COUNTS.contains(this);
    }
